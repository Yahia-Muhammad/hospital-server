...
const editDoctor = asyncWrapper(async (req, res) => {
  const doctor = await Nutrition.updateOne(
    { _id: req.params.id },
    { $set: { ...req.body } }
  );
