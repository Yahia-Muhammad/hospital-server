...
const editDoctor = asyncWrapper(async (req, res) => {
  const doctor = await Dental.updateOne(
    { _id: req.params.id },
    { $set: { ...req.body } }
  );
