...
const editDoctor = asyncWrapper(async (req, res) => {
  const doctor = await Radiology.updateOne(
    { _id: req.params.id },
    { $set: { ...req.body } }
  );
